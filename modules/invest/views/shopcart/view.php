...
<th>Umumiy summa</th><td><b><?= number_format($model->cost, 2, ',', ' '); ?></b></td>
</tr>
...
<div class="container">
    ...
    <table id="w0" class="table table-striped table-bordered detail-view">
        <tbody>
            ...
            <?php $i=0;
                foreach ($model->goods as $key => $item) : $i++;?>
            <tr>
                <td><?= $i ?></td>
                ...
                <td><a href="<?=Url::to(['shopcart/edit', 'id' => $item->good_id,'order'=>$model->order_id])?>">Taxrirlash</a></td>
                <td><a href="<?=Url::to(['shopcart/del', 'id' => $item->good_id,'order'=>$model->order_id])?>">O`chirish</a></td>
