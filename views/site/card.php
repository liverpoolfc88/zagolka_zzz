    ...
    <table id="customers">
        ...
        <?php if ($items->goods) : ?>
            <?php foreach ($items->goods as $key => $item) : ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= Url::to('/?slug=' . $item->item->template->slug . '&item_slug=' . $item->item->slug) ?>">
                            <h5 class="product_title"><?= $item->item->title ?>
                                &nbsp;<span>(<?= $item->item->template->title ?>)</span></h5>
                        </a>
                    </td>
                    <td>
                        <? if ($item->item->sale): ?>
                    ...
                    <td>
                        <a class="remove-item remove" href="#" data-id="<?= $item->good_id ?>"
                           data-value="<?= $item->price ?>" title="<?= Lang::t('Remove Item From Cart') ?>">
                            <button type="button" data-id="169" title="Remove" class="btn btn-danger delete"><i
        ...
        <tr style="border-top:solid">
            ...
            <td>
                ...
                <!--         <input  id="sa" class="btn btn-danger center" type="button" value="-->
                <? //=Lang::t('Update')?><!--">-->
            </td>
        </tr>
        </tfoot>
